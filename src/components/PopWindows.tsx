        ...
        return (
            <div className="z-50 confirm-dialog-overlay flex justify-center fixed w-full top-44 left-1 right-1 px-4 pl-2">
                <div className="confirm-dialog w-[92%] max-w-lg ">
                    ...
                    <div className='bg-stone-300 rounded-tl-none rounded-md p-4 px-5 min-h-40 flex-col flex justify-between shadow-md shadow-stone-100 max-h-[300px] overflow-y-auto'>
